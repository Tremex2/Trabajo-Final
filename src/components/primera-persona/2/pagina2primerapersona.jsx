      ...
      <div className="container">
        <div className="grid">
          <div className="card">
            ...
            <Link className="titulo" to={"/primera-persona/2/apex-legends"}>
              <h4>Apex Legends</h4>
            </Link>
          </div>
          <div className="card">
            ...
            <Link
              className="titulo"
              to={"/primera-persona/2/clide-barkers-jericho"}
            >
              <h4>Clide Barkers Jericho</h4>
            </Link>
          </div>
          <div className="card">
            <img src={crysis2} alt="" className="image" />
            <Link className="titulo" to={"/primera-persona/2/crysis-2"}>
              <h4>Crysis 2</h4>
            </Link>
          </div>
          <div className="card">
            <img src={crysis} alt="" className="image" />
            <Link className="titulo" to={"/primera-persona/2/crysis"}>
              <h4>Crysis</h4>
            </Link>
          </div>
          <div className="card">
            <img src={crysis3} alt="" className="image" />
            <Link className="titulo" to={"/primera-persona/2/crysis-3"}>
              <h4>Crysis 3</h4>
            </Link>
          </div>
          <div className="card">
            <img src={deusEx} alt="" className="image" />
            <Link className="titulo" to={"/primera-persona/2/deus-ex"}>
              <h4>Deus Ex</h4>
            </Link>
          </div>
          <div className="card">
            ...
            <Link
              className="titulo"
              to={"/primera-persona/2/escape-from-tarkov"}
            >
          ...
          <div className="card">
            ...
            <Link
              className="titulo"
              to={"/primera-persona/2/fear-2-proyect-origin"}
            >
              <h4>Fear 2 proyect origin</h4>
            </Link>
          </div>
          <div className="card">
            <img src={tf2} alt="" className="image" />
            <Link className="titulo" to={"/primera-persona/2/team-fortress-2"}>
