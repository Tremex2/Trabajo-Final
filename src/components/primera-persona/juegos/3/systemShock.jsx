...
import imagen1 from "../../../../public/primera-persona/juegos/3/System Shock/jsystem shock-1.jpg";
import imagen2 from "../../../../public/primera-persona/juegos/3/System Shock/jsystem shock-2.jpg";
import imagen3 from "../../../../public/primera-persona/juegos/3/System Shock/jsystem shock-3.jpg";
  ...
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 30 MAY 2023</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">
          Tarjeta de vídeo: NVIDIA GTX 970 4GB/AMD Radeon R9 290 4GB or better
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">System Shock</h1>
            ...
            <h3 className="letras-juegos">
              ¡Una lucha a muerte en primera persona en las profundidades del
              espacio!
            </h3>
          </div>
                  ...
                  cambiarContenido(
                    <div>
                      ...
                      <ul>
                        ...
                        <li className="lista-general">Memoria: 8 GB RAM</li>
                        <li className="lista-general">
                          Tarjeta de vídeo: NVIDIA GTX 970 4GB/AMD Radeon R9 290
                          4GB or better
                        </li>
                      </ul>
                    </div>,
