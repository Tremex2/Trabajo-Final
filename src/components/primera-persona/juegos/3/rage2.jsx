...
import imagen1 from "../../../../public/primera-persona/juegos/3/rage 2/jrage 2-1.jpg";
import imagen2 from "../../../../public/primera-persona/juegos/3/rage 2/jrage 2-2.jpg";
import imagen3 from "../../../../public/primera-persona/juegos/3/rage 2/jrage 2-3.jpg";
  ...
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 14 MAY 2019</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">
          Procesador: Intel Core i7-4770 or AMD Ryzen 5 1600X
        </li>
        <li className="lista-general">Memoria: 8 GB RAM</li>
        <li className="lista-general">
          Tarjeta de vídeo: Nvidia GTX 1070 8GB or AMD Vega 56 8GB
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">rage 2</h1>
            ...
            <h3 className="letras-juegos">
              RAGE 2 es fruto de la colaboración entre dos pesos pesados como
              son Avalanche Studios, expertos en la creación de demenciales
              mundos abiertos, e id Software, los creadores de los shooters en
              primera persona; y ofrece un frenesí de masacres en el que podrás
              visitar cualquier sitio, disparar a cualquier cosa y volarlo todo
              por los aires.
            </h3>
          </div>
                  ...
                  cambiarContenido(
                    <div>
                      ...
                      <ul>
                        ...
                        <li className="lista-general">Memoria: 8 GB RAM</li>
                        <li className="lista-general">
                          Tarjeta de vídeo: Nvidia GTX 1070 8GB or AMD Vega 56
                          8GB
                        </li>
                      </ul>
                    </div>,
