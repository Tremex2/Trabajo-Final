            ...
            <div className="container">
                <div className="grid">
                    <div className="card">
                        ...
                        <Link className="titulo" to={"/terror/4/clock-tower"}><h4>Clock Tower</h4></Link>
                    </div>
                    <div className="card">
                        <img src={goneHome} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/gone-home"}><h4>Gone Home</h4></Link>
                    </div>
                    <div className="card">
                        <img src={houseOfAshes} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/house-of-ashes"}><h4>House of ashes</h4></Link>
                    </div>
                    <div className="card">
                        <img src={sunlessSkies} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/sunless-skies"}><h4>Sunless skies</h4></Link>
                    </div>
                    <div className="card">
                        <img src={theCatLady} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/the-cat-lady"}><h4>the cat lady</h4></Link>
                    </div>
                    <div className="card">
                        <img src={theSinkingCity} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/the-sinking-city"}><h4>the sinking city</h4></Link>
                    </div>
                    <div className="card">
                        <img src={yummeNikki} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/yumme-nikki"}><h4>yumme nikki</h4></Link>
                    </div>
                    <div className="card">
                        <img src={blairWitch} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/blair-witch"}><h4>Blair Witch</h4></Link>
                    </div>
                    <div className="card">
                        <img src={silenHill4} alt="" className="image" />
                        <Link className="titulo" to={"/terror/4/silent-hill-4"}><h4>Silent Hill 4</h4></Link>
                    </div>
                </div>
            </div>
