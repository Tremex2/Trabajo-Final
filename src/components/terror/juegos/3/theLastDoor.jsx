...
import imagen1 from "../../../../public/terror/juegos/3/the last door/juegothelastdoor-1.jpg";
import imagen2 from "../../../../public/terror/juegos/3/the last door/juegothelastdoor-2.jpg";
import imagen3 from "../../../../public/terror/juegos/3/the last door/juegothelastdoor-3.jpg";

export function TheLastDoor() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        <li className="lista-general">Version: mayo de 2017</li>
        <li className="lista-general">
          Idiomas: Inglés, Español (Latinoamérica y España), Francés, Alemán,
          Italiano
        </li>
        <li className="lista-general">Fecha de salida: 20 MAY 2014</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">Procesador: Dual Core 2.4 GHz</li>
        <li className="lista-general">Memoria: 2 GB RAM</li>
        <li className="lista-general">
          Tarjeta de vídeo: Dedicated with 128 MB RAM
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">the last door</h1>
            ...
            <h3 className="letras-juegos">
              Algo antiguo y malvado se agita en la Inglaterra Victoriana. Sólo
              tú puedes detenerlo. Viaja al corazón de la locura y más allá
              adentrándote solo en la oscuridad.
            </h3>
          </div>
