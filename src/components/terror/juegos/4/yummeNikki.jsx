...
import imagen1 from "../../../../public/terror/juegos/4/yume nikki/juegoyume nikki-1.jpg";
import imagen2 from "../../../../public/terror/juegos/4/yume nikki/juegoyume nikki-2.jpg";
import imagen3 from "../../../../public/terror/juegos/4/yume nikki/juegoyume nikki-3.jpg";

export function YummeNikki() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        <li className="lista-general">Version: mayo de 2018</li>
        <li className="lista-general">Idiomas: Inglés,Japonés</li>
        <li className="lista-general">Fecha de salida: 10 ENE 2018</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">
          Procesador: MMX Pentium(R)200MHz pentium(R)II450MHz o superior
          recomendado
        </li>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Yume Nikki</h1>
            ...
            <h3 className="letras-juegos">
              Este es un juego en el que recorres el mundo extremadamente oscuro
              dentro de un sueño.
            </h3>
          </div>
                  ...
                  cambiarContenido(
                    <div>
                      ...
                      <ul>
                        ...
                        <li className="lista-general">
                          Procesador: MMX Pentium(R)200MHz pentium(R)II450MHz o
