...
import imagen1 from "../../../../public/terror/juegos/4/clock tower/juegoclock tower-3.jpg";
import imagen2 from "../../../../public/terror/juegos/4/clock tower/juegoclock tower-2.jpg";
import imagen3 from "../../../../public/terror/juegos/4/clock tower/juegoclock tower-1.jpg";

export function ClockTower() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        <li className="lista-general">Version: 1997 </li>
        <li className="lista-general">
          Idiomas: Inglés, Español (Latinoamérica y España), Francés, Alemán,
          Italiano, Ruso, Chino simplificado y Japonés
        </li>
        <li className="lista-general">
          Fecha de salida: 14 de septiembre de 1995
        </li>
      </ul>
      <ul>
        ...
        <li className="lista-general">Procesador: Intel Core i3-6300</li>
        <li className="lista-general">Memoria: 4 GB RAM</li>
        <li className="lista-general">
          Tarjeta de vídeo: GeForce GTX 750Ti (VRAM 2GB)
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">clock tower</h1>
            ...
            <h3 className="letras-juegos">
              Clock Tower, es el primer videojuego de terror perteneciente a la
              saga de Horror de supervivencia Clock Tower, creado por Human
              Entertainment para Super Famicom y publicado solo en Japón en
              1995.
            </h3>
          </div>
                    ...
                    <div>
                      <ul className="">
                        ...
                        <li className="lista-general">
                          ...
                          Francés, Alemán, Italiano, Ruso, Chino simplificado y
                          Japonés
                        </li>
                        <li className="lista-general">
                          Fecha de salida: 14 de septiembre de 1995
