...
import imagen1 from "../../../../public/terror/juegos/3/visage/juegovisage-1.jpg";
import imagen2 from "../../../../public/terror/juegos/3/visage/juegovisage-2.jpg";
import imagen3 from "../../../../public/terror/juegos/3/visage/juegovisage-3.jpg";

export function Visage() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        <li className="lista-general">Version: enero de 2021</li>
        ...
        <li className="lista-general">Fecha de salida: 30 OCT 2020</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">
          Tarjeta de vídeo: NVIDIA® GeForce® GTX 1060 or AMD Radeon™ RX 480
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">visage</h1>
            ...
            <h3 className="letras-juegos">
              Visage es un juego de terror psicológico en primera persona.
              Explora una misteriosa casa en constante cambio sumergiéndote
              lentamente en una atmósfera que combina entornos acogedores e
              inquietantes con otros terroríficamente realistas, y disfruta de
                  ...
                  cambiarContenido(
                    <div>
                      ...
                      <ul>
                        ...
                        <li className="lista-general">Memoria: 8 GB RAM</li>
                        <li className="lista-general">
                          Tarjeta de vídeo: NVIDIA® GeForce® GTX 1060 or AMD
                          Radeon™ RX 480
                        </li>
                      </ul>
                    </div>,
