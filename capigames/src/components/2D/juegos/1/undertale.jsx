...
import imagen1 from "../../../../public/2D/juegos/1/undertale/jundertale-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/undertale/jundertale-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/undertale/jundertale-3.jpg";
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Undertale</h1>
            ...
            <h3 className="letras-juegos">
              UNDERTALE! El juego de rol en el que no tienes que destruir a
              nadie.
            </h3>
          </div>
