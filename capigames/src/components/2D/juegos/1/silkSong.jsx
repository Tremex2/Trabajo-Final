...
import imagen1 from "../../../../public/2D/juegos/1/Hollow Knight Silksong/jhollow knight2-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/Hollow Knight Silksong/jhollow knight2-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/Hollow Knight Silksong/jhollow knight2-3.jpg";

export function SilkSong() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: Por confirmarse</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Hollow Knight: Silksong</h1>
            ...
            <h3 className="letras-juegos">
              ¡Descubre un vasto reino embrujado en Hollow Knight: Silksong! La
              secuela del galardonado juego de acción y aventuras. Explora,
              lucha y sobrevive mientras asciendes a la cima de una tierra
              gobernada por la seda y la canción.
            </h3>
          </div>
                  ...
                  cambiarContenido(
                    <div>
                      <ul className="">
                        ...
                        <li className="lista-general">
                          Fecha de salida: Por confirmarse
                        </li>
                      </ul>
                      <ul>
                        <li className="lista-general">Requisitos</li>
