...
import imagen1 from "../../../../public/2D/juegos/1/stardew valley/jstardew valley-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/stardew valley/jstardew valley-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/stardew valley/jstardew valley-3.jpg";
  ...
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 26 FEB 2016</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">stardew valley</h1>
            ...
            <h3 className="letras-juegos">
              Acabas de heredar la vieja parcela agrícola de tu abuelo de
              Stardew Valley. Decides partir hacia una nueva vida con unas
              herramientas usadas y algunas monedas. ¿Te ves capaz de vivir de
              la tierra y convertir estos campos descuidados en un hogar
              próspero?
            </h3>
          </div>
