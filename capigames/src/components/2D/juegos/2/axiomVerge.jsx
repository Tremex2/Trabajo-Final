...
import imagen1 from "../../../../public/2D/juegos/2/axiom verge/jaxiom-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/axiom verge/jaxiom-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/axiom verge/jaxiom-3.jpg";

export function AxiomVerge() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 14 MAY 2015</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">axiom verge</h1>
            ...
            <h3 className="letras-juegos">
              Explora y desvela el misterio de un surrealista mundo alienígena
              destruyendo extraterrestres y creando fallos en el entorno de este
              intenso juego retro de acción/aventura y desplazamiento lateral.
            </h3>
          </div>
