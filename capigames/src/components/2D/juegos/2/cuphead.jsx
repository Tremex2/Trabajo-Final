...
import imagen1 from "../../../../public/2D/juegos/2/cuphead/jcup-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/cuphead/jcup-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/cuphead/jcup-3.jpg";

export function Cuphead() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 29 SEP 2017</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Cuphead</h1>
            ...
            <h3 className="letras-juegos">
              Cuphead es un juego de acción clásico estilo "dispara y corre" que
              se centra en combates contra el jefe. Inspirado en los dibujos
              animados de los años 30, los aspectos visual y sonoro están
              diseñados con esmero empleando las mismas técnicas de la época, es
              decir, animación tradicional a mano, fondos de acuarela y
              grabaciones...
            </h3>
          </div>
