...
import imagen1 from "../../../../public/2D/juegos/2/enter the gungeon/jgun-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/enter the gungeon/jgun-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/enter the gungeon/jgun-3.jpg";

export function EnterTheGungeon() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 5 ABR 2016</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Enter the Gungeon</h1>
            ...
            <h3 className="letras-juegos">
              Enter the Gungeon es un dungeon crawler de tiroteos que sigue a
              una banda de marginados arrepentidos en su intento de conseguir la
              absolución personal a base de disparar, saquear, dar volteretas y
              voltear mesas para alcanzar el tesoro supremo de la legendaria
              Armazmorra: el arma que puede matar el pasado.
            </h3>
          </div>
