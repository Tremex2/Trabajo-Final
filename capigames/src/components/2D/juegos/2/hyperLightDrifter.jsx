...
import imagen1 from "../../../../public/2D/juegos/2/hyper light drifter/jhyper-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/hyper light drifter/jhyper-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/hyper light drifter/jhyper-3.jpg";

export function HyperLightDrifter() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 31 MAR 2016</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Hyper Light Drifter</h1>
            ...
            <h3 className="letras-juegos">
              Explore a beautiful, vast and ruined world riddled with dangers
