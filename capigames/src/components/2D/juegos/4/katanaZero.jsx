...
import imagen1 from "../../../../public/2D/juegos/4/Katana Zero/ka1.jpg"
import imagen2 from "../../../../public/2D/juegos/4/Katana Zero/ka2.jpg"
import imagen3 from "../../../../public/2D/juegos/4/Katana Zero/ka3.jpg"
import ImagenCambiable from "../../../carrousel-de-fotos/carrousel";

export function KatanaZero() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 18/abr./2019</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Katana ZERO</h1>
                        ...
                        Katana Zero es un juego de acción y plataformas con un estilo neo-noir donde controlas a un asesino que utiliza habilidades de manipulación del tiempo para eliminar enemigos y completar misiones. Con su jugabilidad rápida y precisa, el juego presenta una narrativa intrigante llena de giros psicológicos y decisiones que afectan el desarrollo de la historia. Su estética pixel art y su intensa banda sonora contribuyen a una experiencia envolvente y estilizada.
                        </h3>
                    </div>
