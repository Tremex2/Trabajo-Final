...
import imagen1 from "../../../../public/2D/juegos/4/Slain back from hell/sl1.jpg"
import imagen2 from "../../../../public/2D/juegos/4/Slain back from hell/sl2.jpg"
import imagen3 from "../../../../public/2D/juegos/4/Slain back from hell/sl3.jpg"
import ImagenCambiable from "../../../carrousel-de-fotos/carrousel";

export function SlainBackFromHell() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 24/mar./2016</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Slain back from hell</h1>
                        ...
                        Slain: Back from Hell es un juego de acción y plataformas en 2D que combina elementos de metal gótico y fantasía oscura. Juegas como Bathoryn, un héroe que regresa de la muerte para luchar contra demonios y monstruos en un mundo lleno de criaturas espantosas. Con combates desafiantes, un estilo artístico pixelado y una banda sonora heavy metal, el juego ofrece una experiencia intensa, centrada en la habilidad y la estrategia en un entorno sombrío y atmosférico.
                        </h3>
                    </div>
