...
import imagen1 from "../../../../public/2D/juegos/4/Blasphemous/bl1.jpg";
import imagen2 from "../../../../public/2D/juegos/4/Blasphemous/bl2.jpg";
import imagen3 from "../../../../public/2D/juegos/4/Blasphemous/bl3.jpg";
import ImagenCambiable from "../../../carrousel-de-fotos/carrousel";

export function Blasphemous() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 10/set./2019</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Blasphemous</h1>
            ...
            <h3 className="letras-juegos">
              Blasphemous es un juego de plataformas y acción en 2D que combina
              elementos de metroidvania y un estilo visual gótico. Ambientado en
              el mundo de Cvstodia, juegas como el Penitente, un guerrero en una
              búsqueda de redención mientras lucha contra enemigos grotescos y
              jefes inspirados en la iconografía religiosa. Con una narrativa
              profunda que explora temas de culpa y sacrificio, el juego ofrece
              combates desafiantes y un entorno sombrío lleno de secretos y
              exploración.
            </h3>
          </div>
