...
import imagen1 from "../../../../public/primera-persona/juegos/2/crysis 2/jcrysis2-1.jpg";
import imagen2 from "../../../../public/primera-persona/juegos/2/crysis 2/jcrysis2-2.jpg";
import imagen3 from "../../../../public/primera-persona/juegos/2/crysis 2/jcrysis2-3.jpg";
export function Crysis2() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 17 NOV 2022</li>
      </ul>
      <ul>
        ...
        <li className="lista-general">
          Procesador: Intel(R) Core(TM) i5-8600 or higher
        </li>
        <li className="lista-general">Memoria: 16 GB RAM</li>
        <li className="lista-general">
          Tarjeta de vídeo: NVIDIA GeForce GTX 1660 TI
        </li>
      </ul>
    </div>,
    "general"
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">crysis 2</h1>
            ...
            <h3 className="letras-juegos">
              Revive la legendaria campaña de un jugador del clásico shooter en
              primera persona, Crysis 2, optimizada para los dispositivos
              actuales en Crysis 2 Remastered.
            </h3>
          </div>
            ...
            <div className="letras-juegos inline">
              ...
              <div
                ...
                onClick={() =>
                  cambiarContenido(
                    <ul>
                      <li className="lista-general">Peso del juego: 54GB</li>
