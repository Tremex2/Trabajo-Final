...
import imagen1 from "../../../../public/images/juegos/1/the last of us/tlou1.jpg"
import imagen2 from "../../../../public/images/juegos/1/the last of us/tlou2.jpg"
import imagen3 from "../../../../public/images/juegos/1/the last of us/tlou3.jpg"

export function Tlou() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">the last of us</h1>
                        ...
                        <h3 className="letras-juegos">
                            este juego de acción y aventura sigue a Joel y Ellie mientras viajan a través de un Estados Unidos post-apocalíptico. La historia se centra en su relación y en los desafíos que enfrentan contra humanos hostiles y criaturas infectadas
                        </h3>
                    </div>
