...
import imagen1 from "../../../../public/images/juegos/1/doom eternal/doometernal1.jpg"
import imagen2 from "../../../../public/images/juegos/1/doom eternal/doometernal2.jpg"
import imagen3 from "../../../../public/images/juegos/1/doom eternal/doometernal3.jpg"

export function DoomEternal() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Doom Eternal</h1>
                        ...
                        <h3 className="letras-juegos">
                            Es un juego de disparos en primera persona lanzado en 2020. Sigues al Doom Slayer en su misión para salvar la Tierra de las fuerzas demoníacas del Infierno. El juego es conocido por su acción rápida y brutal, así como por su énfasis en el combate agresivo.
                        </h3>
                    </div>
