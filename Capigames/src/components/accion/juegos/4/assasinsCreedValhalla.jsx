...
import imagen1 from "../../../../public/images/juegos/4/assasins creed valhalla/assasinscreedvalhalla1.jpg"
import imagen2 from "../../../../public/images/juegos/4/assasins creed valhalla/assasinscreedvalhalla2.jpg"
import imagen3 from "../../../../public/images/juegos/4/assasins creed valhalla/assasinscreedvalhalla3.jpg"

export function AssassinsCreedValhalla() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Assasins Creed Valhalla</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de acción y aventuras en mundo abierto ambientado en la era vikinga, donde los jugadores lideran incursiones y exploran la Inglaterra anglosajona.
                        </h3>
                    </div>
