...
import imagen1 from "../../../../public/images/juegos/4/ghost of tushima/ghostoftushima1.jpg"
import imagen2 from "../../../../public/images/juegos/4/ghost of tushima/ghostoftushima2.jpg"
import imagen3 from "../../../../public/images/juegos/4/ghost of tushima/ghostoftushima3.jpg"

export function GhostOfTushima() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Ghost of Tushima</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de mundo abierto ambientado en el Japón feudal, donde los jugadores controlan a un samurái que lucha contra la invasión mongola.
                        </h3>
                    </div>
