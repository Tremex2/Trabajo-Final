...
import imagen1 from "../../../../public/images/juegos/4/sekiro shadows die twice/sekiroshadowsdietwice1.jpg"
import imagen2 from "../../../../public/images/juegos/4/sekiro shadows die twice/sekiroshadowsdietwice2.jpg"
import imagen3 from "../../../../public/images/juegos/4/sekiro shadows die twice/sekiroshadowsdietwice3.jpg"

export function SekiroShadowsDieTwice() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Sekiro shadows die twice</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de acción con un enfoque en la precisión y el sigilo, donde los jugadores controlan a un guerrero shinobi en una versión mítica del Japón feudal.
                        </h3>
                    </div>
