...
import imagen1 from "../../../../public/images/juegos/4/bloodborne/bloodborne1.jpg"
import imagen2 from "../../../../public/images/juegos/4/bloodborne/bloodborne2.jpg"
import imagen3 from "../../../../public/images/juegos/4/bloodborne/bloodborne3.jpg"

export function Bloodborne() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Bloodborne</h1>
                        ...
                        <h3 className="letras-juegos">
                            RPG de acción en un mundo gótico y oscuro, con combates rápidos y desafiantes, donde los jugadores enfrentan criaturas aterradoras y cazan monstruos.
                        </h3>
                    </div>
