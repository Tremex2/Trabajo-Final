...
import imagen1 from "../../../../public/images/juegos/4/horizon zero dawn/horizonzerodawn1.jpg"
import imagen2 from "../../../../public/images/juegos/4/horizon zero dawn/horizonzerodawn2.jpg"
import imagen3 from "../../../../public/images/juegos/4/horizon zero dawn/horizonzerodawn3.jpg"

export function HorizonZeroDawn() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Horizon Zero Dawn</h1>
                        ...
                        <h3 className="letras-juegos">
                            RPG de acción en un futuro postapocalíptico donde los jugadores cazan máquinas gigantes en un vasto mundo abierto lleno de tribus y misterios tecnológicos.
                        </h3>
                    </div>
