...
import imagen1 from "../../../../public/images/juegos/2/deathloop/deathloop1.jpg"
import imagen2 from "../../../../public/images/juegos/2/deathloop/deathloop2.jpg"
import imagen3 from "../../../../public/images/juegos/2/deathloop/deathloop3.jpg"

export function DeathLoop() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Deathloop</h1>
                        ...
                        <h3 className="letras-juegos">
                            Lanzado en 2021, es un juego de disparos en primera persona desarrollado por Arkane Lyon. Sigues a Colt, un asesino atrapado en un bucle temporal, que debe eliminar a ocho objetivos antes de que el día se reinicie
                        </h3>
                    </div>
