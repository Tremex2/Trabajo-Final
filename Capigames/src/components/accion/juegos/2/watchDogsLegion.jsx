...
import imagen1 from "../../../../public/images/juegos/2/watch dogs legion/watchdogslegion1.jpg"
import imagen2 from "../../../../public/images/juegos/2/watch dogs legion/watchdogslegion2.jpg"
import imagen3 from "../../../../public/images/juegos/2/watch dogs legion/watchdogslegion3.jpg"

export function WatchDogsLegion() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">watch dogs legion</h1>
                        ...
                        <h3 className="letras-juegos">
                            Este juego de acción y aventura de 2020 permite a los jugadores reclutar y controlar a cualquier personaje en un Londres futurista. La historia sigue a un grupo de hackers que luchan contra un régimen autoritario2
                        </h3>
                    </div>
