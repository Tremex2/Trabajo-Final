...
import imagen1 from "../../../../public/images/juegos/2/remnant from the ashes/remnantfromtheashes1.jpg"
import imagen2 from "../../../../public/images/juegos/2/remnant from the ashes/remnantfromtheashes2.jpg"
import imagen3 from "../../../../public/images/juegos/2/remnant from the ashes/remnantfromtheashes3.jpg"

export function RemnantFromTheAshes() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Remnant from the ashes</h1>
                        ...
                        <h3 className="letras-juegos">
                            Lanzado en 2019, es un juego de acción y supervivencia en tercera persona. Los jugadores luchan contra criaturas monstruosas en un mundo post-apocalíptico, utilizando una combinación de armas de fuego y combate cuerpo a cuerpo
                        </h3>
                    </div>
