...
import imagen1 from "../../../../public/images/juegos/3/jedi fallen order/jedifallenorder1.jpg"
import imagen2 from "../../../../public/images/juegos/3/jedi fallen order/jedifallenorder2.jpg"
import imagen3 from "../../../../public/images/juegos/3/jedi fallen order/jedifallenorder3.jpg"

export function JediFallenOrder() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Jedi Fallen Order</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de acción y aventuras en tercera persona en el universo de Star Wars, centrado en un joven Jedi en su lucha contra el Imperio.
                        </h3>
                    </div>
