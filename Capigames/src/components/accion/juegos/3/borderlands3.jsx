...
import imagen1 from "../../../../public/images/juegos/3/borderlands 3/Borderlands31.jpg"
import imagen2 from "../../../../public/images/juegos/3/borderlands 3/Borderlands32.jpg"
import imagen3 from "../../../../public/images/juegos/3/borderlands 3/Borderlands33.jpg"

export function Borderlands3() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Borderlands 3</h1>
                        ...
                        <h3 className="letras-juegos">
                            Shooter en primera persona con un estilo gráfico cel-shading, lleno de humor, loot y acción cooperativa en un mundo abierto postapocalíptico.
                        </h3>
                    </div>
