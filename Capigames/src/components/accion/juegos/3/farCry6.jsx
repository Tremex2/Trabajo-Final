...
import imagen1 from "../../../../public/images/juegos/3/far cry 6/farcry61.jpg"
import imagen2 from "../../../../public/images/juegos/3/far cry 6/farcry62.jpg"
import imagen3 from "../../../../public/images/juegos/3/far cry 6/farcry63.jpg"

export function FarCry6() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Far cry 6</h1>
                        ...
                        <h3 className="letras-juegos">
                            Shooter en primera persona ambientado en una isla ficticia gobernada por un dictador, donde los jugadores lideran una revolución.
                        </h3>
                    </div>
