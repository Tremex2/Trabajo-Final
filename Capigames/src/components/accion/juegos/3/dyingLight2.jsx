...
import imagen1 from "../../../../public/images/juegos/3/dying light 2/dyinglight21.jpg"
import imagen2 from "../../../../public/images/juegos/3/dying light 2/dyinglight22.jpg"
import imagen3 from "../../../../public/images/juegos/3/dying light 2/dyinglight23.jpg"

export function DyingLight2() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Dying  Light 2</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de mundo abierto con parkour y zombies, donde las decisiones del jugador influyen en el desarrollo de la trama y el entorno.
                        </h3>
                    </div>
