...
import imagen1 from "../../../../public/images/juegos/3/shadows of war/shadowsofwar1.jpg"
import imagen2 from "../../../../public/images/juegos/3/shadows of war/shadowsofwar2.jpg"
import imagen3 from "../../../../public/images/juegos/3/shadows of war/shadowsofwar3.jpg"

export function ShadowsOfWar() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Shadows of war</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de acción en mundo abierto, donde los jugadores controlan a un guerrero con poderes sobrehumanos para luchar contra el ejército de Sauron.
                        </h3>
                    </div>
