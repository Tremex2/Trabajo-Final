...
import imagen1 from "../../../../public/2D/juegos/1/hotline miami 1/jhotline1-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/hotline miami 1/jhotline1-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/hotline miami 1/jhotline1-3.jpg";

export function HotlineMiami() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 23 OCT 2012</li>
      </ul>
      <ul>
        ...
        <div className="contenedor-juegos">
          <div className="juego">
            ...
            <h3 className="letras-juegos">
              Hotline Miami es un juego de acción de alto octanaje que rebosa
              brutalidad es estado puro, violentos tiroteos y demoledores
