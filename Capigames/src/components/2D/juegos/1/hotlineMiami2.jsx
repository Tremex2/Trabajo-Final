...
import imagen1 from "../../../../public/2D/juegos/1/hotline miami 2/jhotline2-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/hotline miami 2/jhotline2-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/hotline miami 2/jhotline2-3.jpg";

export function HotlineMiami2() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 10 MAR 2015</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Hotline Miami 2: Wrong Number</h1>
            ...
            <h3 className="letras-juegos">
              Hotline Miami 2: Wrong Number es la brutal conclusión de la saga
              Hotline Miami que se desarrolla en plena escalada de violencia y
              venganza por la sangre derramada en el juego original.
            </h3>
          </div>
