...
import imagen1 from "../../../../public/2D/juegos/1/hollowknight/jhollow knight-1.jpg";
import imagen2 from "../../../../public/2D/juegos/1/hollowknight/jhollow knight-2.jpg";
import imagen3 from "../../../../public/2D/juegos/1/hollowknight/jhollow knight-3.jpg";

export function HollowKnight() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 24 FEB 2017</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">hollow knight</h1>
            ...
            <h3 className="letras-juegos">
              ...
              ruinas. Explora cavernas tortuosas, combate contra criaturas
              corrompidas y entabla amistad con extraños insectos, todo en un
              estilo clásico en 2D dibujado a mano.
            </h3>
          </div>
