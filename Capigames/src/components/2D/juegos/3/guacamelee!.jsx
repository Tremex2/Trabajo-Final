...
import imagen1 from "../../../../public/2D/juegos/3/guacamelee!/ga1.jpg"
import imagen2 from "../../../../public/2D/juegos/3/guacamelee!/ga2.jpg"
import imagen3 from "../../../../public/2D/juegos/3/guacamelee!/ga3.jpg"
import ImagenCambiable from "../../../carrousel-de-fotos/carrousel";

export function Guacamelee() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 21/ago./2018</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Guacamelee2!</h1>
                        ...
                        <h3 className="letras-juegos">
                            Guacamelee! es un juego de acción y plataformas estilo metroidvania inspirado en la cultura mexicana y el folclore. Juegas como Juan, un luchador enmascarado que debe rescatar a su amada y salvar el mundo de fuerzas sobrenaturales. Con combate cuerpo a cuerpo, habilidades especiales y un toque de humor, el juego mezcla niveles desafiantes con un vibrante arte visual y música animada.
                        </h3>
                    </div>
