...
import imagen1 from "../../../../public/2D/juegos/3/Owlboy/ow1.jpg"
import imagen2 from "../../../../public/2D/juegos/3/Owlboy/ow1.jpg"
import imagen3 from "../../../../public/2D/juegos/3/Owlboy/ow1.jpg"
import ImagenCambiable from "../../../carrousel-de-fotos/carrousel";

export function Owlboy() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 1/nov./2016</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Owlboy</h1>
                        ...
                        Owlboy es un juego de plataformas y aventuras en 2D con un hermoso arte pixelado. Sigues a Otus, un joven búho que, junto a sus amigos, debe salvar su aldea de piratas celestiales. El juego combina exploración, vuelo y combate, ofreciendo una emotiva historia sobre la amistad, la superación personal y la valentía.
                        </h3>
                    </div>
