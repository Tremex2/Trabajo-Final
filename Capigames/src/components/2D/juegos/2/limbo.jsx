...
import imagen1 from "../../../../public/2D/juegos/2/limbo/jlimbo-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/limbo/jlimbo-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/limbo/jlimbo-3.jpg";
  ...
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 2 AGO 2011</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">limbo</h1>
