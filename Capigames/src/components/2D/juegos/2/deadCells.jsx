...
import imagen1 from "../../../../public/2D/juegos/2/dead cells/jdead-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/dead cells/jdead-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/dead cells/jdead-3.jpg";

export function DeadCells() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 6 AGO 2018</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">dead cells</h1>
            ...
            <h3 className="letras-juegos">
              Dead Cells es un juego de acción de plataformas de estilo
              roguelite inspirado en juegos tipo metroidvania. Explorarás un
              castillo en constante cambio y expansión. Sin puntos de control:
              mata, muere, aprende, repite.
            </h3>
          </div>
