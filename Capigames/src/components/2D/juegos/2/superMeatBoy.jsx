...
import imagen1 from "../../../../public/2D/juegos/2/Super Meat Boy/jboy-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/Super Meat Boy/jboy-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/Super Meat Boy/jboy-3.jpg";

export function SuperMeatBoy() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 30 NOV 2010</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Super Meat Boy</h1>
            ...
            <h3 className="letras-juegos">
              ¡El infame juego de plataformas duro como el acero llega a Steam e
              incluye un Head Crab con el que podrás jugar (exclusivo de Steam)!
            </h3>
          </div>
