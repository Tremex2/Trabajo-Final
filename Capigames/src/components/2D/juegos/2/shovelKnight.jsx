...
import imagen1 from "../../../../public/2D/juegos/2/Shovel Knight Shovel of Hope/jshovel-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/Shovel Knight Shovel of Hope/jshovel-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/Shovel Knight Shovel of Hope/jshovel-3.jpg";

export function ShovelKnight() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 26 JUN 2014</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Shovel Knight: Shovel of Hope</h1>
            ...
            <h3 className="letras-juegos">
              ¡Shovel Knight es un arrasador clásico de acción-aventura con
              jugabilidad apasionante, personajes memorables y estética retro de
              8-bits! Si disfrutas con plataformeo perfecto, arte precioso,
              música contagiosa, jefes entrañables, humor, ligereza y corazón...
              ¡Shovel Knight es para ti!
            </h3>
          </div>
