...
import imagen1 from "../../../../public/2D/juegos/2/Ori and the Blind Forest/jforest-1.jpg";
import imagen2 from "../../../../public/2D/juegos/2/Ori and the Blind Forest/jforest-2.jpg";
import imagen3 from "../../../../public/2D/juegos/2/Ori and the Blind Forest/jforest-3.jpg";

export function OriAndTheBlindForest() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 11 MAR 2015</li>
      </ul>
      <ul>
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">Ori and the Blind Forest</h1>
            ...
            <h3 className="letras-juegos">
              Ori and the Blind Forest narra la historia de un joven huérfano
              destinado a convertirse en leyenda a través de un juego de acción
              y plataformas preciosista creado por Moon Studios para PC.
            </h3>
          </div>
