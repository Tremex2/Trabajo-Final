...
import imagen1 from "../../../../public/primera-persona/juegos/4/far cry 3/farcry31.jpg"
import imagen2 from "../../../../public/primera-persona/juegos/4/far cry 3/farcry32.jpg"
import imagen3 from "../../../../public/primera-persona/juegos/4/far cry 3/farcry33.jpg"

export function FarCry3() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 29 de noviembre de 2012.</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Far cry 3</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de mundo abierto donde el jugador debe sobrevivir en una isla tropical llena de peligros y enfrentarse a un villano carismático.
                        </h3>
                    </div>
