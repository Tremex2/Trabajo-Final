...
import imagen1 from "../../../../public/primera-persona/juegos/4/doom 1973/doom1993.jpg"
import imagen2 from "../../../../public/primera-persona/juegos/4/doom 1973/doom19932.jpg"
import imagen3 from "../../../../public/primera-persona/juegos/4/doom 1973/doom19933.jpg"

export function DOOM1963() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 10 de diciembre de 1993.</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Doom</h1>
                        ...
                        <h3 className="letras-juegos">
                            Clásico del género FPS que definió la acción rápida, combates contra demonios y diseño de niveles laberínticos.
                        </h3>
                    </div>
