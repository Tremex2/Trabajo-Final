...
import imagen1 from "../../../../public/primera-persona/juegos/4/metro last night/metro1.jpg"
import imagen2 from "../../../../public/primera-persona/juegos/4/metro last night/metro2.jpg"
import imagen3 from "../../../../public/primera-persona/juegos/4/metro last night/metro 3.jpg"

export function MetroLastNight() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 14 de mayo de 2013.</li>
        </ul>
        <ul>
                ...
                <div className="contenedor-juegos">
                    <div className="juego">
                        ...
                        <h3 className="letras-juegos">
                            FPS post-apocalíptico ambientado en los túneles del metro de Moscú, donde los supervivientes enfrentan mutantes y facciones enemigas.
                        </h3>
                    </div>
