...
import imagen1 from "../../../../public/primera-persona/juegos/4/call of duty modern warfare/modernwarfare1.jpg"
import imagen2 from "../../../../public/primera-persona/juegos/4/call of duty modern warfare/modernwarfare2.jpg"
import imagen3 from "../../../../public/primera-persona/juegos/4/call of duty modern warfare/modernwarfare4.jpg"

export function CallOfDutyMordernWarfare() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 25 de octubre de 2007.</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Modern Warfare</h1>
                        ...
                        <h3 className="letras-juegos">
                            Modern Warfare: Shooter bélico moderno que revolucionó el género con una narrativa intensa y un multijugador innovador en conflictos contemporáneos.
                        </h3>
                    </div>
