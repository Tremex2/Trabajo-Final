...
import imagen1 from "../../../../public/primera-persona/juegos/4/battlefield/battlefield1.jpg"
import imagen2 from "../../../../public/primera-persona/juegos/4/battlefield/battlefield2.jpg"
import imagen3 from "../../../../public/primera-persona/juegos/4/battlefield/battlefield3.jpg"
...
export function BattleField() {
    const [contenido, setContenido] = useState(<div>
        <ul className="">
            ...
            <li className="lista-general">Fecha de salida: 10 de septiembre de 2002.</li>
        </ul>
        <ul>
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Battlefield</h1>
                        ...
                        <h3 className="letras-juegos">
                            Juego de disparos en primera persona ambientado en la Segunda Guerra Mundial, conocido por sus batallas multijugador a gran escala y el uso de vehículos.
                        </h3>
                    </div>
