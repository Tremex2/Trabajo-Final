...
import imagen1 from "../../../../public/terror/juegos/2/eternal darkness/juegoeternal-darkness-1.jpg";
import imagen2 from "../../../../public/terror/juegos/2/eternal darkness/juegoeternal-darkness-2.jpg";
import imagen3 from "../../../../public/terror/juegos/2/eternal darkness/juegoeternal-darkness-3.jpg";

export function EternalDarkness() {
  const [contenido, setContenido] = useState(
    <div>
      <ul className="">
        ...
        <li className="lista-general">Fecha de salida: 24 junio 2002</li>
      </ul>
      <ul>
        <li className="lista-general">Requisitos</li>
        <li className="lista-general">
          Sistema operativo: Windows 7 32/64 bits
        </li>
        <li className="lista-general">
          Procesador: Intel Core i5-4300 or equivalen
        </li>
        <li className="lista-general">Memoria: 4 GB RAM</li>
        <li className="lista-general">Tarjeta de vídeo: Integrated GPU</li>
      </ul>
    </div>,
    "general"
  );
    ...
    <>
      <div className="contenedor-del-contenedor-juegos">
        <div className="contenedor-juegos">
          <div className="juego">
            <h1 className="letras-juegos">eternal darkness</h1>
            ...
            <h3 className="letras-juegos">
              Eternal Darkness: Sanity's Requiem es un videojuego del género
              terror psicológico para la plataforma Nintendo GameCube
            </h3>
          </div>
                  ...
                  cambiarContenido(
                    <div>
                      ...
                      <ul>
                        ...
                        <li className="lista-general">Memoria: 4 GB RAM</li>
                        <li className="lista-general">
                          Tarjeta de vídeo: Integrated GPU
                        </li>
                      </ul>
                    </div>,
                    "general"
