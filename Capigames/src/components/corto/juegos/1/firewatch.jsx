...
import imagen1 from "../../../../public/corto/juegos/1/firewatch/fire1.jpg"
import imagen2 from "../../../../public/corto/juegos/1/firewatch/fire2.jpg"
import imagen3 from "../../../../public/corto/juegos/1/firewatch/fire3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Firewatch</h1>
                        ...
                        <h3 className="letras-juegos">
                            Una aventura narrativa en primera persona ambientada en la naturaleza, donde asumes el rol de un vigilante de incendios y te comunicas con tu supervisora a través de una radio, desentrañando un misterio.
                        </h3>
                    </div>
