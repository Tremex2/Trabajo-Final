...
import imagen1 from "../../../../public/corto/juegos/1/journey/journey1.jpg"
import imagen2 from "../../../../public/corto/juegos/1/journey/journey2.jpg"
import imagen3 from "../../../../public/corto/juegos/1/journey/journey3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Journey</h1>
                        ...
                        <h3 className="letras-juegos">
                            Una experiencia visual y emocional en la que un viajero anónimo cruza vastos desiertos para llegar a la cima de una montaña, con una jugabilidad minimalista.
                        </h3>
                    </div>
