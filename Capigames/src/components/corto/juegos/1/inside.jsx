        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Inside</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un oscuro y atmosférico juego de plataformas con una narrativa implícita, donde controlas a un niño que escapa de siniestros escenarios distópicos.
                        </h3>
                    </div>
