...
import imagen1 from "../../../../public/corto/juegos/1/the begginers guide/guide1.jpg"
import imagen2 from "../../../../public/corto/juegos/1/the begginers guide/guide2.jpg"
import imagen3 from "../../../../public/corto/juegos/1/the begginers guide/guide3.jpg"

export function TheBegginersGuide() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The begginers Guide</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego narrativo introspectivo que explora la naturaleza de la creatividad, la autorreflexión y la relación entre el jugador y el creador.
                        </h3>
                    </div>
