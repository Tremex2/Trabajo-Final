...
import imagen1 from "../../../../public/corto/juegos/1/to the moon/moon1.jpg"
import imagen2 from "../../../../public/corto/juegos/1/to the moon/moon2.jpg"
import imagen3 from "../../../../public/corto/juegos/1/to the moon/moon3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">To The Moon</h1>
                        ...
                        <h3 className="letras-juegos">
                            Una aventura narrativa sobre dos médicos que cumplen el último deseo de un hombre moribundo al alterar sus recuerdos, llevándolo a viajar a la luna.
                        </h3>
                    </div>
