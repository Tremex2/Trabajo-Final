...
import imagen1 from "../../../../public/corto/juegos/1/gris/gris1.jpg"
import imagen2 from "../../../../public/corto/juegos/1/gris/gris2.jpg"
import imagen3 from "../../../../public/corto/juegos/1/gris/gris3.jpg"

export function Gris() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Gris</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un hermoso juego de plataformas y aventuras sobre el dolor y la recuperación emocional, con un estilo artístico impresionante y música evocadora.
                        </h3>
                    </div>
