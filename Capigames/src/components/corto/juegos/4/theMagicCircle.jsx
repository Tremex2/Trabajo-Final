...
import imagen1 from "../../../../public/corto/juegos/4/the magic circle/magic1.jpg"
import imagen2 from "../../../../public/corto/juegos/4/the magic circle/magic2.jpg"
import imagen3 from "../../../../public/corto/juegos/4/the magic circle/magic3.jpg"

export function TheMagicCircle() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The Magic Circle</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de aventuras satírico donde controlas a un personaje atrapado en un videojuego incompleto, alterando su código y diseño para resolver problemas y terminar el juego abandonado por sus creadores.
                        </h3>
                    </div>
