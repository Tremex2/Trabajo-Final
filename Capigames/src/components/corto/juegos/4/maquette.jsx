...
import imagen1 from "../../../../public/corto/juegos/4/maquette/maquette1.jpg"
import imagen2 from "../../../../public/corto/juegos/4/maquette/maquette2.jpg"
import imagen3 from "../../../../public/corto/juegos/4/maquette/maquette3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Maquette</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de rompecabezas en primera persona basado en la manipulación de la escala, donde exploras un mundo en miniatura dentro de un mundo más grande, y viceversa, mientras una historia de amor se despliega.
                        </h3>
                    </div>
