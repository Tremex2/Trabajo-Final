...
import imagen1 from "../../../../public/corto/juegos/4/the red strings club/strings1.jpg"
import imagen2 from "../../../../public/corto/juegos/4/the red strings club/strings2.jpg"
import imagen3 from "../../../../public/corto/juegos/4/the red strings club/strings3.jpg"

export function TheRedStringsClub() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The red strings Club</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un thriller ciberpunk narrativo donde juegas como un barman y un hacker, desentrañando una conspiración corporativa sobre el control emocional de la sociedad a través de la manipulación de recuerdos y emociones.
                        </h3>
                    </div>
