...
import imagen1 from "../../../../public/corto/juegos/4/ender lilies/ender.jpg"
import imagen2 from "../../../../public/corto/juegos/4/ender lilies/ender.webp"
import imagen3 from "../../../../public/corto/juegos/4/ender lilies/ender3.jpg"

export function EnderLilies() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Ender Lilies</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un metroidvania oscuro de acción y plataformas donde controlas a una joven sacerdotisa que, con la ayuda de espíritus caídos, lucha contra enemigos en un mundo devastado.
                        </h3>
                    </div>
