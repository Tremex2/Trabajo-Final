...
import imagen1 from "../../../../public/corto/juegos/4/the bradwell conspiracy/conspiracy1.jpg"
import imagen2 from "../../../../public/corto/juegos/4/the bradwell conspiracy/conspiracy2.jpg"
import imagen3 from "../../../../public/corto/juegos/4/the bradwell conspiracy/conspiracy3.jpg"

export function TheBradwellConspiration() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The bradwell Conspiracy</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un thriller en primera persona en el que debes escapar de una instalación de investigación tras una explosión, utilizando tecnología de impresión 3D y trabajando con una aliada misteriosa para descubrir una conspiración.
                        </h3>
                    </div>
