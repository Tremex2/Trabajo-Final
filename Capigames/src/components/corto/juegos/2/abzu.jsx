...
import imagen1 from "../../../../public/corto/juegos/2/abzu/abzu1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/abzu/abzu2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/abzu/abzu3.jpg"

export function Abzu() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Abzu</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un relajante juego de exploración submarina, donde nadas a través de coloridos océanos y descubres secretos antiguos en un mundo acuático lleno de vida.
                        </h3>
                    </div>
