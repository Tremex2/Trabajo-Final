...
import imagen1 from "../../../../public/corto/juegos/2/donut country/donut1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/donut country/donut2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/donut country/donut3.jpg"

export function DonutCountry() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Donut Country</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un divertido juego de puzzles donde controlas un agujero en el suelo que se hace más grande al tragarse objetos, causando caos en una ciudad mientras desentrañas una historia peculiar.
                        </h3>
                    </div>
