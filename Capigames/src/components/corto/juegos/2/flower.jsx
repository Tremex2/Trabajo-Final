...
import imagen1 from "../../../../public/corto/juegos/2/flower/flower.jpg"
import imagen2 from "../../../../public/corto/juegos/2/flower/flower2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/flower/flower3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Flower</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego poético donde controlas el viento para guiar pétalos de flores a través de paisajes hermosos, desbloqueando color y vida en un mundo tranquilo.
                        </h3>
                    </div>
