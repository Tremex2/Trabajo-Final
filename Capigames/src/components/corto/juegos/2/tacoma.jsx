...
import imagen1 from "../../../../public/corto/juegos/2/tacoma/tacoma1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/tacoma/tacoma2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/tacoma/tacoma3.jpg"

export function Tacoma() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Tacoma</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de ciencia ficción narrativa donde exploras una estación espacial abandonada y descubres, a través de registros de realidad aumentada, la historia del equipo que vivía allí.
                        </h3>
                    </div>
