...
import imagen1 from "../../../../public/corto/juegos/2/the room/room1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/the room/room2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/the room/room3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The room</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un enigmático juego de rompecabezas en 3D, donde resuelves intricados mecanismos y secretos dentro de misteriosas cajas, desentrañando un profundo misterio.
                        </h3>
                    </div>
