...
import imagen1 from "../../../../public/corto/juegos/2/dear esther/esther1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/dear esther/esther2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/dear esther/esther3.jpg"

export function DearEsther() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Dear Esther</h1>
                        ...
                        <h3 className="letras-juegos">
                            Una experiencia narrativa en primera persona ambientada en una isla desolada, donde exploras el entorno mientras escuchas fragmentos de una carta misteriosa que revela una historia melancólica.
                        </h3>
                    </div>
