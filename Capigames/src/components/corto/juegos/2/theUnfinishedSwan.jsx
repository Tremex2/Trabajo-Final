...
import imagen1 from "../../../../public/corto/juegos/2/the unfinished swan/swan1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/the unfinished swan/swan2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/the unfinished swan/swan3.jpg"

export function TheUnfinishedSwan() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The unfinished swan</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de aventura y exploración en el que sigues a un niño en un mundo surrealista y en blanco, arrojando pintura para descubrir el entorno mientras persigues a un cisne.
                        </h3>
                    </div>
