...
import imagen1 from "../../../../public/corto/juegos/2/stanley parable/stanley1.jpg"
import imagen2 from "../../../../public/corto/juegos/2/stanley parable/stanley2.jpg"
import imagen3 from "../../../../public/corto/juegos/2/stanley parable/stanley3.jpg"

export function StanleyParable() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Stanley Parable</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de exploración narrativa y sátira en primera persona, donde las decisiones del jugador desafían y subvierten la naturaleza de la elección y el libre albedrío en los videojuegos.
                        </h3>
                    </div>
