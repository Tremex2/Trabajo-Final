...
import imagen1 from "../../../../public/corto/juegos/3/the last campfire/campfire1.jpg"
import imagen2 from "../../../../public/corto/juegos/3/the last campfire/campfire2.jpg"
import imagen3 from "../../../../public/corto/juegos/3/the last campfire/campfire3.jpg"

export function TheLastCampfire() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The last Campfire</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de aventuras donde ayudas a una pequeña criatura a encontrar su propósito mientras exploras un misterioso y hermoso mundo lleno de acertijos y personajes perdidos.
                        </h3>
                    </div>
