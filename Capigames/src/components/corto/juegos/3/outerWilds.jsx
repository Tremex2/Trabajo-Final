        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Outer Wilds</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de exploración espacial en un sistema solar atrapado en un ciclo temporal, donde investigas misterios antiguos y descubres secretos antes de que todo vuelva a empezar.
                        </h3>
                    </div>
