...
import imagen1 from "../../../../public/corto/juegos/3/super liminal/liminal.jpg"
import imagen2 from "../../../../public/corto/juegos/3/super liminal/liminal2.jpg"
import imagen3 from "../../../../public/corto/juegos/3/super liminal/liminal1.jpg"

export function SuperLiminal() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Super Liminal</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un ingenioso juego de rompecabezas en primera persona basado en la perspectiva forzada, donde cambias el tamaño y la forma de los objetos jugando con ilusiones ópticas.
                        </h3>
                    </div>
