...
import imagen1 from "../../../../public/corto/juegos/3/telling lies/lies1.jpg"
import imagen2 from "../../../../public/corto/juegos/3/telling lies/lies2.jpg"
import imagen3 from "../../../../public/corto/juegos/3/telling lies/lies3.jpg"

export function TellingLies() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Telling Lies</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego narrativo interactivo donde revisas videollamadas grabadas para desenmarañar una intrincada historia de espionaje y relaciones personales.
                        </h3>
                    </div>
