...
import imagen1 from "../../../../public/corto/juegos/3/maifold garden/maifold1.jpg"
import imagen2 from "../../../../public/corto/juegos/3/maifold garden/maifold2.jpg"
import imagen3 from "../../../../public/corto/juegos/3/maifold garden/maifold3.jpg"

export function MaifoldGarden() {
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">Maifold Garden</h1>
                        ...
                        <h3 className="letras-juegos">
                            : Un juego de rompecabezas en un mundo de geometría imposible, donde exploras estructuras que desafían la gravedad y la lógica para resolver desafíos visualmente impresionantes.
                        </h3>
                    </div>
