...
import imagen1 from "../../../../public/corto/juegos/3/the witness/witness1.jpg"
import imagen2 from "../../../../public/corto/juegos/3/the witness/witness2.jpg"
import imagen3 from "../../../../public/corto/juegos/3/the witness/witness3.jpg"
        ...
        <>
            <div className="contenedor-del-contenedor-juegos">
                <div className="contenedor-juegos">
                    <div className="juego">
                        <h1 className="letras-juegos">The witness</h1>
                        ...
                        <h3 className="letras-juegos">
                            Un juego de rompecabezas en primera persona ambientado en una isla desierta, donde resuelves intrincados desafíos para desentrañar los secretos del lugar y su relación con la percepción.
                        </h3>
                    </div>
